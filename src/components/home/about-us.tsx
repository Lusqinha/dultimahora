...
export function AboutUs() {
    return (
        <section className="py-16">
                ...
                <div className="grid md:grid-cols-3 mx-2 gap-8">
                    <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-[#FFC006] border-opacity-50 hover:border-opacity-100 transition duration-300 ease-in-out transform hover:-translate-y-2">
                        ...
                        <p className="text-gray-600 text-center">
                            Somos um grupo de universitários de Santa Maria, apaixonados por facilitar o acesso a eventos e festas.
                            Cansados da complexidade em revender ou encontrar ingressos a preços acessíveis, decidimos criar uma
                            solução que simplifica todo esse processo.
                        </p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-[#FFC006] border-opacity-50 hover:border-opacity-100 transition duration-300 ease-in-out transform hover:-translate-y-2">
                        ...
                        <p className="text-gray-600 text-center">
                            Nosso objetivo é criar uma comunidade vibrante em torno dos eventos de Santa Maria. Queremos tornar a
                            compra e venda de ingressos de última hora rápida e fácil. Assim, você não terá prejuízo se não puder ir a
                            um evento, e poderá encontrar ótimas ofertas de lotes anteriores.
                        </p>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-[#FFC006] border-opacity-50 hover:border-opacity-100 transition duration-300 ease-in-out transform hover:-translate-y-2">
                        ...
                        <p className="text-gray-600 text-center">
                            Estamos sempre prontos para atender você e garantir que tudo funcione perfeitamente. Conte conosco para
                            qualquer dúvida ou sugestão sobre o site. Trabalhamos continuamente para melhorar nossa plataforma e em
                            breve traremos um app funcional para você!
                        </p>
                    </div>
                </div>
            ...
            <hr className=" w-11/12 mx-auto mt-20" />
        </section>
    )
}
